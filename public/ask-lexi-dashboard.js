        ...
        .map((business) => {
          ...
          return `
            <article class="channel-row" data-admin-notif-business-id="${escapeHtml(business.id || "")}">
              ...
              <div>
                <small class="status-negative">Needs delivery review</small>
                <div class="inline-actions">
...
function evaluateAdminNotificationHealth(business) {
...
function buildAdminNotificationLexiPrompt(business, mode = "fix") {
