...
describe("public shell pwa wiring", () => {
  ...
  it("registers the shared service worker from active page entrypoints", () => {
    ...
    expect(readPublicFile("ask-lexi-dashboard.js")).toContain('import { registerServiceWorker } from "./pwa-runtime.js";');
    expect(readPublicFile("ask-lexi-dashboard.js")).toContain("registerServiceWorker();");
